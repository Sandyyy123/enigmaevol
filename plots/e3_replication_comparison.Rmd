...
rep_1_ancreg=read.csv("/data/clusterfs/lag/users/gokala/enigma-evol/corvals/ancreg_replication/corvalues_surface_Full_replication_ancreg.Rdata_ancreg_BJK.csv")
...
#pdf("/data/workspaces/lag/workspaces/lg-ukbiobank/projects/enigma_evol/enigma_evo/evolution/ohbm/corvalues_e3_vs_replication_darkgray.pdf", width = 8, height = 4)
...
ggplot(merged2, aes(fct_rev(reorder(Region,my.order)), LDSC_intercept,color=Anc_reg)) + 
  ...
  geom_point(position = position_dodge(0.9), size = 2) + facet_grid(. ~ sample_f) +
...
#ggsave("/data/workspaces/lag/workspaces/lg-ukbiobank/projects/enigma_evol/enigma_evo/evolution/ohbm/plots/e3_rep_LDSC_intercepts_before_after_ancreg_w_errorbars_surfaceArea4.pdf", width = 9, height = 9, unit = "in")
#ggsave("/data/workspaces/lag/workspaces/lg-ukbiobank/projects/enigma_evol/enigma_evo/evolution/ohbm/plots/e3_rep_LDSC_intercepts_before_after_ancreg_w_errorbars_surfaceArea6.png", unit = "in",dpi = 400)
```
...
p=ggplot(data = merged3, aes(Region, Prop._h2.x)) +
