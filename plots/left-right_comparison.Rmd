...
ggscatter(for_scatter_woFP, x = "right_prop", y = "left_prop",  color = "#EEA300",
          add = "reg.line", cor.coef = TRUE, cor.method = "pearson",
          xlab = "Right Hemisphere", ylab = "Left Hemisphere", title = "Proportion of heritability") +           theme_bw()
#ggsave("/data/workspaces/lag/workspaces/lg-ukbiobank/projects/enigma_evol/enigma_evo/evolution/results/plots/partitioned_heritability/european_lr/eur_l-r_proph2_scatter_wo_frontalpole.pdf",height = 8,width = 8)
...
for_bar2 = for_bar2[-which(for_bar2$Region=="frontalpole"),]
for_bar2 = for_bar2[-which(for_bar2$Region=="rostralanteriorcingulate"),]

g.mid = ggplot(for_bar2,aes(x=1,y=fct_rev(Region))) + 
