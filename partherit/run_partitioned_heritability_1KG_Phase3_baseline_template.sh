...
--overlap-annot \
--ref-ld-chr /data/clusterfs/lag/users/gokala/enigma-evol/partherit/amanda_annotations/${fannot}/${annot}.,/data/clusterfs/lag/users/gokala/enigma-evol/partherit/baselineLD/baselineLD.  \
