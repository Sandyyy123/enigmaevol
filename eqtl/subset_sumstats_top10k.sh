...
#---------------------------------------------------------------------- 
sumstatsDir="/data/clusterfs/lag/users/gokala/enigma-evol/data/european_hemave"
sortedDir="/data/workspaces/lag/workspaces/lg-ukbiobank/projects/enigma_evol/enigma_evo/evolution/data/european_hemave/pvalue_sorted"
genotypeFile="/data/workspaces/lag/shared_spaces/Resource_DB/1KG_phase3/GRCh37/plink/1KG_phase3_GRCh37_EUR_nonFIN_allchr"
outDir="/data/clusterfs/lag/users/gokala/enigma-evol/selection_analysis/clumped_sumstats/european_hemave"
